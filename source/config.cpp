...
namespace kraken {
    ...
    Config::Config() {
        ...
        this->contact_surface_layer = { "constants", "contact_surface_layer", 0.01,  true,  0,     1.0         };
        this->cfm                   = { "constants", "cfm",                   0.001, true,  0,     1.0         };
        this->erp                   = { "constants", "erp",                   0.1,   true,  0,     1.0         };

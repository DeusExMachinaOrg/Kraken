...
enum Props
{
    PROP_MODEL_CAST_SHADOW         = 0x0,
    PROP_SERVER_SLOT               = 0x1,
    PROP_MODEL_WIND_WAVY           = 0x1,
    PROP_SERVER_SLOT_1             = 0x2,
    PROP_MODEL_TRANS               = 0x2,
    PROP_NODE_LAST_DEFAULT         = 0x3,
    PROP_MODEL_2SIDED              = 0x3,
    PROP_MODEL_TESSELLATE          = 0x4,
    PROP_MODEL_TRACK_LAND          = 0x5,
    PROP_MODEL_CAST_SHADOWVOL      = 0x6,
    PROP_MODEL_LAST_DEFAULT        = 0x7,

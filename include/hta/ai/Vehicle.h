...
namespace ai
{
    ...
    struct Vehicle : ComplexPhysicObj
    {
        ...
        /* 0x01ec */ std::map<int,Gadget*> m_gadgets;
        ...
        /* 0x024c */ std::deque<float,std::allocator<float> > m_recentEngineRpms;
        ...
        /* 0x027c */ std::set<ref_ptr<Obstacle>,std::less<ref_ptr<Obstacle> >,std::allocator<ref_ptr<Obstacle> > > m_currentNearbyObstacles;
        /* 0x0288 */ std::set<ref_ptr<Obstacle>,std::less<ref_ptr<Obstacle> >,std::allocator<ref_ptr<Obstacle> > > m_pastNearbyObstacles;
        ...
        /* 0x02b4 */ std::set<m3d::Class *,std::less<m3d::Class *>,std::allocator<m3d::Class *> > m_targetClasses;
        ...
        /* 0x0320 */ std::map<int,bool,std::less<int>,std::allocator<std::pair<int const ,bool> > > m_gunsPointed;
        ...
        /* 0x0354 */ std::vector<enum ActionType,std::allocator<enum ActionType> > m_effectActions;
